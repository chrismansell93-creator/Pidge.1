...
export default function PrivacyPage() {
  return (
    <LegalPage title="Privacy Policy">
      <p>Last updated 22 August 2026. Pidge (“we”) is a location-based dating and social discovery app for adults 18+.</p>
      ...
      <p>Other users see the profile you publish and an approximate distance. Google Play processes Unlimited payments. When the site is hosted on Vercel, we use Vercel Web Analytics and Speed Insights for anonymous page-view and performance metrics (URL paths are redacted so chat IDs are not sent). We may share data if required by law or to investigate harm.</p>
